        ...
        <div className="max-w-2xl mx-auto py-8">
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h1 className="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Booking Cancelled</h1>
              <p className="text-zinc-600 dark:text-zinc-400">Your booking has been successfully cancelled.</p>
            </div>
      ...
      <div className="max-w-2xl mx-auto py-8">
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Cancel Your Booking</h1>
          </div>
          ...
          {booking.status === 'cancelled' ? (
            ...
            <>
              <div className="p-6 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg shadow-sm dark:shadow-zinc-700/30">
                <h2 className="text-xl font-semibold text-zinc-900 dark:text-white mb-4">Booking Details</h2>
                
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <IconCalendarEvent size={20} className="text-zinc-400 dark:text-zinc-500 mt-0.5" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <IconClock size={20} className="text-zinc-400 dark:text-zinc-500 mt-0.5" />
                    <div>
                  ...
                  {booking.notes && (
                    <div className="pt-3 border-t border-zinc-100 dark:border-zinc-700">
                      ...
                      <p className="text-zinc-900 dark:text-white">{booking.notes}</p>
                    </div>
                  )}
                  ...
                  {booking.name && (
                    <div className="flex items-start gap-3">
                      <div>
                        ...
                        <p className="font-medium text-zinc-900 dark:text-white">{booking.name}</p>
                      </div>
                    </div>
                  )}
                </div>
