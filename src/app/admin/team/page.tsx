  ...
  return (
    <AppLayout title="Manage Team">
      <div className="space-y-6">
        <section>
          <h2 className="text-4xl font-bold text-zinc-900 dark:text-white mb-6">Manage Team</h2>
      ...
      >
        {selectedUser && (
          <div className="space-y-6">
            <div className="">
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white">{selectedUser.email}</h3>
            ...
            <div>
              <h4 className="font-medium text-zinc-900 dark:text-white mb-3">Change Role To:</h4>
              <div className="flex flex-wrap gap-2">
